...
//Note :: JS এ array ডাইনামিক হয়ে থাকে, এর length কখনও নির্দিষ্ট হয়না

// Array --> Flexible Size and Behavior

// let arr = new Array(3); // এখানে আপনি ভাববেন ৩ length এর একটি array declear করেছি
// arr[0] = 10;
// arr[1] = 20;
// arr[2] = 30;
// arr[3] = 40; // কিন্তু আমি length 4 (index 3) তেও value set করতে পারছি কারণ জেএস এ array ডাইনামিক

// arr[10] = 110; // আপনি এর length যত ইচ্ছা বাড়াতে পারবেন
// console.log(arr); //[ 10, 20, 30, 40, <6 empty items>, 110 ]
// console.log(arr.length); //11; আমি ৩ length ওয়ালা একটা array declear করেছিলাম কিন্তু সেটাতে এখন আমি ১১ টা value সংরক্ষণ করেছি

// Note:: Array is linear Data Structure which stores multiple value in a continious manner
